...
- Security First: Runs as a non-root user (container).
- Automatic update without intervention
...
| **Others**          | `ENABLE_AUTO_UPDATE` | enable auto-update                               | `true`                                                |
| **Others**          | `SERVER_PATH`        | container path for server                        | `/game`                                               |
